...
import { getDepartmentAttendances, getStudentAttendances } from "@/services/Attendance";
      ...
      <>
        ...
        <div className="event__list__container">
          <div className="relative event__list__container">
            ...
            >
              {allAttendances && allAttendances?.courseAttendanceTable?.length > 0 && (
                <div className="overflow-x-auto">
                  <table className="w-full text-xs bg-white border-collapse px-5">
                    ...
                    <tbody>
                      {allAttendances && allAttendances?.courseAttendanceTable?.length > 0 && allAttendances?.courseAttendanceTable?.map((item: any, index: number) => (
                        <tr
                          key={index}
                        ...
                        >
                          ...
                          <td className="py-3 hidden xl:table-cell">
                            {item?.course?.lecturer?.firstname + ' ' + item?.course?.lecturer?.lastname}
                          </td>
              ...
              {isLoading && (
                <div
                  className={classNames(
                    ...
                    {
                      "h-full": allAttendances?.courseAttendanceTable?.length <= 0,
                    },
                  )}
                >
                  <LoaderIcon />
